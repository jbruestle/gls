...
#define TESTOP_ALL  (TESTOP_ADD | TESTOP_SUB | TESTOP_MUL | TESTOP_CMP | TESTOP_MODADD | TESTOP_MODSUB | TESTOP_MODMUL | TESTOP_MODMUL2 | TESTOP_DIVREM | TESTOP_MODINV)
#define TESTOP_SET  TESTOP_ALL
